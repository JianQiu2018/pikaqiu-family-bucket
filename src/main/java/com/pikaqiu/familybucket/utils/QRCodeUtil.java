...
public class QRCodeUtil {
    ...
    public static void main(String[] args) throws Exception {
        // 存放在二维码中的内容
        // 二维码中的内容可以是文字，可以是链接等
        String text = "http://pkqing.cn:8000/apidoc/index.html";
        // 嵌入二维码的图片路径
        String imgPath = "D:\\qj_workspace\\微信图片_20200825172532.jpg";
        // 生成的二维码的路径及名称
        String destPath = "D:\\qj_workspace\\file\\code" + System.currentTimeMillis() + ".jpg";
        //生成二维码
